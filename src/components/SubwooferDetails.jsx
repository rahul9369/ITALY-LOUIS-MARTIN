...
const products = [
...

  {
    ...
    model: "KS218",
    description:
      " The KS – 218 is a high-performance, bandpass ported enclosure designed passive subwoofer, equipped with a high-power European driver, it provides exceptional sound quality and reliability. The birch plywood construction gives the robust,  rigidness & perfect acoustics to the long term uses. The KS – 218 is engineered to meet the demands of the installation and rental market, making it a reliable choice for professionals seeking high performance audio solutions.",
    application: [
      "Live Events",
      "Auditoriums",
      "Multi-functional Hall",
...

  {
    ...
    Type: "Passive Subwoofer Speaker",
    Frequency_Response: "35 Hz – 120 Hz",
    LF_Drivers: "1 x 18” High performance driver 4.5” voice coil",
    // HF_Drivers: "1 x 1.75” (44 mm) HF Driver",
    RMS_Power: "1000W",
    Program_Power: "2000W",
    Peak_Power: "4000W",
...

  {
    ...
    model: "S218",
    description:
      " The S – 218 is a high-performance, front loaded enclosure designed passive subwoofer, equipped with a high-power European driver, it provides exceptional sound quality and reliability. The multi-layer high density plywood construction gives the robust,  rigidness & perfect acoustics to the long term uses. The S – 218 is engineered to meet the demands of the installation and rental market, making it a reliable choice for professionals seeking high performance audio solutions.",
    application: [
      "Live Events",
      "Auditoriums",
      "Multi-functional Hall",
    ...
    Type: "Passive Subwoofer Speaker",
    Frequency_Response: "35 Hz – 150 Hz",
    LF_Drivers: "2 x 18” High performance driver 4.5” voice coil",
    // HF_Drivers: "1 x 1.75” (44 mm) HF Driver",
    RMS_Power: "2000W",
    Program_Power: "4000W",
    Peak_Power: "8000W",
